...
Horse.create!(make: 1, mold: 1, released_as: 'Zafira', breed: 1, color: 'Liver Chestnut', pattern: 'None', gender: 'Mare', finish: 'OF', size: 'Traditional', user_id: 1, location: 'Home Office', verified: true, office_pony: '', purchase_price: 175, condition: 'excellent' )
Horse.create!(make: 1, mold: 1, released_as: 'RD Marciea Bey', breed: 1, color: 'Bay', pattern: 'None', gender: 'Mare', finish: 'OF', size: 'Traditional', user_id: 1, location: 'Living Room Shelves', verified: true, office_pony: '', purchase_price: 175, condition: 'excellent' )
